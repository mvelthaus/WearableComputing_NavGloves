<div id="Home" class="View" data-stack-id="home">
        ...
        <article class="Secondary">
            ...
            <section class="Content">
                  <div class="Group right">
                    <div class="Text"> 
                      <h3>Thank you</h3>
                      <p>The NavGloves have been developed as part of a course at the Hochschule Flensburg, university of applied sciences.</p>
                      <p>The authors would like to thank especially Prof. Dr. Torben Wallbaum for the support and guidance during the project.</p>
                    </div>
                    <aside>
                      <img src="assets/photos/logo_hsfl.png" style="max-width:100%">
                    </aside>
                  </div>
            </section>
