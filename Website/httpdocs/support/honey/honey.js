//
// This file is part of Honey
//
// Copyright (c) 2015 Torben Haase
//
// Honey is free software: you can redistribute it and/or modify it under the
...
// SOFTWARE.
//
// You should have received a copy of the MIT License along with Honey. If not,
...
var loaderMain = self.Honey&&self.Honey.loaderMain!==undefined?self.Honey.loaderMain:'main';

// INFO Boot loader
//      After the main module has been loaded it is passed to this function,
            ...
            document.onreadystatechange = function() {
                switch (document.readyState) {
                    ...
                    case 'complete':
                        ...
                        break;
                    default:
                        throw new Error('Honey: unknown readyState '+document.readyState);
                }
            };
            break;
        default:
...
// INFO Booting
//      The main module is loaded and the boot loader will be called afterwards.

loaderMain && require(loaderMain, boot);
